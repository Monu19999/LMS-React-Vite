                  ...
                  <div className="col-12 px-4 list mt-4 mb-4">
                    ...
                    <ul>
                      {course?.course?.topics?.length > 0 && (
                        <li>{course.course.topics.length} topics</li>
                      )}
                      {course?.course?.topics_uploads_count > 0 && (
                        <li>
                          {course.course.topics_uploads_count} downloadable
                          resources
                        </li>
                      )}
                      <li>Full lifetime access</li>
                      {course.configuration.is_create_cerfiticate == 1 && (<li>Certification of completion</li>)}
                    </ul>
                  </div>
          ...
          <div className="container p-0">
            <div className="container py-3">
              ...
              <div className="row mt-4 list">
                <div className="wow fadeIndown p-0" data-wow-delay="0.1s">
