...
//   console.log(courses);
  ...
  function createLink(item) {
    if (item.menu_type == 1) {
      ...
      return item.db_controller_route ? item.db_controller_route.route : "/";
              ...
              return (
                ...
                >
                  <img
                    className="img-fluid"
                    src={
                      slider?.upload ? ShowImage(slider.upload.file_path) : ""
                    }
                    alt={slider?.upload ? slider.upload.original_name : ""}
                  />
                  <div
      ...
      <div className="container mb-4">
        ...
        <div className="row">
          ...
          >
            <div className="counter-box">
              <span className="counter">
                {homedata.courses_enrolled ? homedata.courses_enrolled : 0}
              </span>
          ...
          >
            <div className="counter-box">
              <span className="counter">
                {homedata.registered_users ? homedata.registered_users : 0}
              </span>
          ...
          <div className="row g-5">
            ...
            {homedata?.page && (
              ...
              >
                ...
                >
                  <h1 className="mb-4">{homedata.page.title_en}</h1>
                  <div className="mb-4">{homedata.page.description_en}</div>
                  <Link
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            {homedata.department_onboarded &&
              homedata.department_onboarded.map((department_onboarded) => {
                return (
                  <div
          ...
          >
            {courses?.courses?.data &&
              ...
              courses.courses.data.map((course) => {
                return (
                  <div className="owl-carousel-item active" key={course.id}>
