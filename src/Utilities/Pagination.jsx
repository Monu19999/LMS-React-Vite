...
class Pagination extends Component {
    ...
    isCurrent = (page) => {
        let currentPage = this.state.paginationData.meta
            ? this.state.paginationData.meta.current_page
            : this.state.paginationData.current_page;
    ...
    generatePagination = () => {
        ...
        if (
            ...
            this.state.paginationData.total > 10
        ) {
            let options = this.state.options;
    ...
    render() {
        return <React.Fragment>{this.generatePagination()}</React.Fragment>;
    }
}
